...
class AdocStatsFormatterTest {
    ...
    void GivenStatsResult_WhenFormat_ThenReturnsExpectedAdoc() {
        ...
        String expected = new StringBuilder()
                ...
                .append("[cols=\"1,1\",options=\"header\"]").append(newline)
    ...
    void GivenEmptyStats_WhenFormat_ThenReturnsAdocWithPlaceholders() {
        ...
        String expected = new StringBuilder()
                ...
                .append("| 95p размера ответа | 0.00b").append(newline)
                .append("|===").append(newline).append(newline)
                .append("=== Запрашиваемые ресурсы").append(newline).append(newline)
                .append("[cols=\"2,1\",options=\"header\"]").append(newline)
                .append("|===").append(newline)
